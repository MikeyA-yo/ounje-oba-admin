...
import { getProductStats } from "@/app/admin/products/actions";
...
export const ProductsCards = () => {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => await getProductStats(),
  });
      ...
      {isLoading || !data ? (
        ...
        <div className="flex flex-col @md/main:grid @md/main:grid-cols-2 @md/main:grid-flow-row @4xl/main:flex @4xl/main:flex-row @4xl/main:flex-wrap gap-4 items-center w-full">
          <DetailCard
            ...
            details={data.total_products.toString()}
            icon="hugeicons:tags"
            iconColor="#5C1978"
            bgColor="#F6F2F7"
          />
          <DetailCard
            title="In Stock"
            details={data.active_products.toString()}
          ...
          <DetailCard
            title="Low Stock"
            details={data.low_stock.toString()}
          ...
          <DetailCard
            title="Out of Stock"
            details={data.out_of_stock.toString()}
